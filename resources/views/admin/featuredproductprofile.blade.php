...
<div class="col-sm-2"> 
		{!! Html::linkRoute('products.edit','Approve',array($product->id),array('class'=>'btn btn-primary btn-block'))!!}<br><br>   
	{!! Html::linkRoute('featuredproduct.edit','Edit',array($product->id),array('class'=>'btn btn-primary btn-block'))!!}<br><br> 

		 {!! Form::open([
			    'method' => 'DELETE',
			    'route' => ['featuredproduct.destroy', $product->id]
			]) !!}
